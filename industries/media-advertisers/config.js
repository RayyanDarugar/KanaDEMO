// ============================================================
// INDUSTRY CONFIG — Media & Advertisers (Auto-generated scaffold)
...
export const industryConfig = {
  ...
  accent: "#7f63c5", // Vertical-specific accent color
  ...
  // ── HERO ───────────────────────────────────────────────────
  hero: {
    headline:     "The AI Marketing Platform <em>Built for Media & Advertisers</em>",
    subheadline:  "[PLACEHOLDER — AI Marketing Orchestration customized for Media & Advertisers brands. Real-time decision systems unifying campaigns, inventory, and citations.]",
  ...
  painPoints: [
    {
      ...
      stat:        "Research shows Media & Advertisers marketers spend up to 45% of their working hours stitching cross-channel data manually.",
    },
    {
    ...
    },
    {
      ...
      stat:        "[PLACEHOLDER — AI suppression metrics for Media & Advertisers launches]"
    },
  ],
  ...
  // ── SOCIAL PROOF ───────────────────────────────────────────
  testimonial: {
    quote: "[PLACEHOLDER — Testimonial from a leading global enterprise in Media & Advertisers]",
    name:  "[Name]",
    title: "[Title], [Media & Advertisers Company]",
  },

  // ── FAQ ────────────────────────────────────────────────────
  faq: [
    { q: "How does Kana integrate with legacy Media & Advertisers systems?",       a: "[PLACEHOLDER]" },
  ...
  // ── FINAL CTA ──────────────────────────────────────────────
  finalCta: {
    headline: "See what Kana can do for your Media & Advertisers brand",
    cta:      { text: "Book a Demo", href: "/demo" },
  },
};