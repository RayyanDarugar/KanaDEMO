// ============================================================
// INDUSTRY CONFIG — Pharma (Auto-generated scaffold)
...
export const industryConfig = {
  slug:   "pharma",
  label:  "Pharma",
  accent: "#3fa673", // Vertical-specific accent color
  ...
  // ── HERO ───────────────────────────────────────────────────
  hero: {
    headline:     "The AI Marketing Platform <em>Built for Pharma</em>",
    subheadline:  "[PLACEHOLDER — AI Marketing Orchestration customized for Pharma brands. Real-time decision systems unifying campaigns, inventory, and citations.]",
  ...
  painPoints: [
    {
      ...
      stat:        "Research shows Pharma marketers spend up to 45% of their working hours stitching cross-channel data manually.",
    },
    {
    ...
    },
    {
      ...
      stat:        "[PLACEHOLDER — AI suppression metrics for Pharma launches]"
    },
  ],
  ...
  // ── SOCIAL PROOF ───────────────────────────────────────────
  testimonial: {
    quote: "[PLACEHOLDER — Testimonial from a leading global enterprise in Pharma]",
    name:  "[Name]",
    title: "[Title], [Pharma Company]",
  },

  // ── FAQ ────────────────────────────────────────────────────
  faq: [
    { q: "How does Kana integrate with legacy Pharma systems?",       a: "[PLACEHOLDER]" },
  ...
  // ── FINAL CTA ──────────────────────────────────────────────
  finalCta: {
    headline: "See what Kana can do for your Pharma brand",
    cta:      { text: "Book a Demo", href: "/demo" },
  },
};