// ============================================================
// INDUSTRY CONFIG — Manufacturing (Auto-generated scaffold)
...
export const industryConfig = {
  slug:   "manufacturing",
  label:  "Manufacturing",
  accent: "#193a4d", // Vertical-specific accent color
  ...
  // ── HERO ───────────────────────────────────────────────────
  hero: {
    headline:     "The AI Marketing Platform <em>Built for Manufacturing</em>",
    subheadline:  "[PLACEHOLDER — AI Marketing Orchestration customized for Manufacturing brands. Real-time decision systems unifying campaigns, inventory, and citations.]",
  ...
  painPoints: [
    {
      ...
      stat:        "Research shows Manufacturing marketers spend up to 45% of their working hours stitching cross-channel data manually.",
    },
    {
    ...
    },
    {
      ...
      stat:        "[PLACEHOLDER — AI suppression metrics for Manufacturing launches]"
    },
  ],
  ...
  // ── SOCIAL PROOF ───────────────────────────────────────────
  testimonial: {
    quote: "[PLACEHOLDER — Testimonial from a leading global enterprise in Manufacturing]",
    name:  "[Name]",
    title: "[Title], [Manufacturing Company]",
  },

  // ── FAQ ────────────────────────────────────────────────────
  faq: [
    { q: "How does Kana integrate with legacy Manufacturing systems?",       a: "[PLACEHOLDER]" },
  ...
  // ── FINAL CTA ──────────────────────────────────────────────
  finalCta: {
    headline: "See what Kana can do for your Manufacturing brand",
    cta:      { text: "Book a Demo", href: "/demo" },
  },
};