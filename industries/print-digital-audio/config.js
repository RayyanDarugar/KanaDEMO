...
export const industryConfig = {
  ...
  solutions: [
    {
      ...
      description: "Audience Builder packages first-party data into premium, direct-sold audience products — no data engineering overhaul required. Segments are built in plain language, so deals stop waiting in an engineering queue.",
    ...
    },
    {
      ...
      description: "LLM Command Center shows which AI crawlers are pulling your content, turning that activity into evidence for licensing conversations — leverage for the traffic bots are now harvesting instead of your readers.",
    ...
    },
    {
      ...
      description: "Pulling data from multiple systems bottlenecks sellers and caps deal volume. Sales Intelligence, including the Media Proposal Generator agent, produces tailored, data-backed proposals in minutes — more deals, same headcount.",
  ...
  personas: [
    {
      ...
      painPoints: [
        ...
        {
          text: "71% of publishers call first-party data a key source of positive ad results — packaging it is still manual work.",
        }
      ],
      solution: {
  ...
  stackShowcase: {
    ...
    subtitle: "Connects to Google Ad Manager, Salesforce, your email platforms, and your subscription stack — no rip-and-replace required.",
    columns: [
      {
