// ============================================================
// INDUSTRY CONFIG — Financial Services (Auto-generated scaffold)
...
export const industryConfig = {
  ...
  accent: "#1762d3", // Vertical-specific accent color
  ...
  // ── HERO ───────────────────────────────────────────────────
  hero: {
    headline:     "The AI Marketing Platform <em>Built for Financial Services</em>",
    subheadline:  "[PLACEHOLDER — AI Marketing Orchestration customized for Financial Services brands. Real-time decision systems unifying campaigns, inventory, and citations.]",
  ...
  painPoints: [
    {
      ...
      stat:        "Research shows Financial Services marketers spend up to 45% of their working hours stitching cross-channel data manually.",
    },
    {
    ...
    },
    {
      ...
      stat:        "[PLACEHOLDER — AI suppression metrics for Financial Services launches]"
    },
  ],
  ...
  // ── SOCIAL PROOF ───────────────────────────────────────────
  testimonial: {
    quote: "[PLACEHOLDER — Testimonial from a leading global enterprise in Financial Services]",
    name:  "[Name]",
    title: "[Title], [Financial Services Company]",
  },

  // ── FAQ ────────────────────────────────────────────────────
  faq: [
    { q: "How does Kana integrate with legacy Financial Services systems?",       a: "[PLACEHOLDER]" },
  ...
  // ── FINAL CTA ──────────────────────────────────────────────
  finalCta: {
    headline: "See what Kana can do for your Financial Services brand",
    cta:      { text: "Book a Demo", href: "/demo" },
  },
};